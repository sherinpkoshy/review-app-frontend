  ...
  return (
    <div className="h-full flex items-center justify-center">
      <FileUploader
        ...
        types={["mp4", "avi"]}
      >
        <label className="w-48 h-48 border border-dashed dark:border-white border-light-subtle rounded-full flex flex-col items-center justify-center dark:text-dark-subtle text-secondary cursor-pointer">
